...
package() {
	...
	packs=(sudo gnupg2 curl nano git xz-utils at-spi2-core xfce4 xfce4-terminal librsvg2-common menu inetutils-tools dialog exo-utils  dbus-x11 gtk2-engines-murrine gtk2-engines-pixbuf apt-transport-https glmark2 mesa-utils sl fastfetch mousepad ristretto xfce4-screenshooter mesa-vulkan-drivers )
	for a in "${packs[@]}"; do
		type -p "$a" &>/dev/null || {
